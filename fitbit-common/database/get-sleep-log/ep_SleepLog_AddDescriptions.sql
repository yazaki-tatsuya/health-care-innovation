...
EXEC sys.sp_updateextendedproperty @name=N'MS_Description', @value=N'日次ナップ回数 (is_main_sleep=0 の件数)', @level0type=N'SCHEMA', @level0name=@sch, @level1type=N'TABLE', @level1name=@tbl, @level2type=N'COLUMN', @level2name=N'nap_count';
EXEC sys.sp_updateextendedproperty @name=N'MS_Description', @value=N'日次ナップ合計分', @level0type=N'SCHEMA', @level0name=@sch, @level1type=N'TABLE', @level1name=@tbl, @level2type=N'COLUMN', @level2name=N'total_nap_minutes';
